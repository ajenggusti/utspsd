...
# Memuat model dan skalar z_score yang telah dilatih
...
with open('best_model_gridsearch.pkl', 'rb') as file:
    knn_zscore = pickle.load(file)

# Aplikasi Streamlit
st.title("Deteksi Emosi Audio")
st.write("Nama : Ajeng Gusti Putri Cempaka Sari")
st.write("NIM  : 210411100010.")
...
if uploaded_file is not None:
    ...
    # Menampilkan pesan jika belum ada file yang diunggah
    st.info('Silakan unggah file audio.')